module.exports = {
    sections: [
        ...
        {
            id: "transitions",
            hash: "/modules/#transitions",
            icon: `<path fill="currentColor" d="M11.108 11.4737a2.2355 2.2355 0 0 0-.1363.7675v2.2431c0 1.845-1.5191 3.3641-3.365 3.3641-1.846 0-3.3641-1.519-3.3641-3.3641V6.6331c0-1.2306-1.0125-2.243-2.243-2.243h-.0019a1.1204 1.1204 0 0 1-.7916-.3286 1.1173 1.1173 0 0 1-.3286-.7916v-.0027c0-.2974.1185-.5823.3286-.7925a1.1195 1.1195 0 0 1 .7916-.3277h.0018c2.4612 0 4.4861 2.025 4.4861 4.4861v7.8512c0 .6144.5058 1.121 1.1211 1.121s1.122-.5066 1.122-1.121v-2.243c0-1.3856.642-2.6536 1.6678-3.4853-.0018.041-.0018.082-.0018.1238 0 .9474.26 1.8343.7133 2.5939Zm4.023-6.6241c2.203 0 3.991 1.788 3.991 3.991 0 2.203-1.788 3.9919-3.991 3.9919-2.203 0-3.9919-1.789-3.9919-3.992 0-2.203 1.789-3.991 3.992-3.991Zm0 2.0827c1.0534 0 1.9083.8549 1.9083 1.9083 0 1.0534-.8549 1.9091-1.9083 1.9091-1.0534 0-1.9091-.8557-1.9091-1.9091s.8557-1.9083 1.9091-1.9083Z"/>`
        },
        {
            id: "typography",
            hash: "/modules/#typography",
